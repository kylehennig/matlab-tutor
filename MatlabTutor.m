classdef MatlabTutor < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            % Creates InstructionsTextAreaLabel.
